...
export default function PracticeArea() {
    return (
        <section className="py-16">
            ...
            <Fade cascade={true} delay={200} direction="up"><p className="text-center">Varius quisque odio mauris lectus consequat sedretium purus feugiat volutpat pellentesque.</p></Fade>
