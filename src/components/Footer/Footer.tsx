...
//     return (
//         <footer style={{ backgroundImage: `url(${images.footer})`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }} className="text-white">
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 container mx-auto pt-[60px]">
//                 <div className="col-span-2 space-y-6">
//                     <div className="flex items-center gap-2">
//                         <img src={icons.logo} alt="logo" />
//                         <h5 className="uppercase text-sm md:text-base lg:text-lg font-bold">Shamiul Islam & Associates</h5>
//                     </div>
//                     <p className="w-1/2">Adipiscing nam neque hendrerit nec pellentesque diam a. Varius quisque odio mauris lectus consequat sed.</p>

//                     <div className="flex items-center gap-2">
//                         <a href="" className="h-8 w-8 bg-white flex justify-center items-center rounded-full text-black"><FaFacebookF /></a>
//                         <a href="" className="h-8 w-8 bg-white flex justify-center items-center rounded-full text-black"><FaXTwitter /></a>
//                         <a href="" className="h-8 w-8 bg-white flex justify-center items-center rounded-full text-black"><FaInstagram /></a>
//                         <a href="" className="h-8 w-8 bg-white flex justify-center items-center rounded-full text-black"><FaLinkedin /></a>
//                     </div>
//                 </div>
//                 <div className="space-y-4">
//                     <h5 className="uppercase text-sm md:text-base lg:text-lg font-bold">Quick Links</h5>
...
//                 </div>
//                 <div className="space-y-4">
//                     <h5 className="uppercase text-sm md:text-base lg:text-lg font-bold">Find us</h5>
//                     <p>25/1 Court House Street, Dhaka, Bangladesh</p>
//                     <p>+880 1711 602 369</p>
//                     <p>info@advprince.com</p>
//                 </div>
//                 <div className="space-y-4">
//                     <h5 className="uppercase text-sm md:text-base lg:text-lg font-bold">Practice Areas</h5>
//                     <ul className="space-y-4">
//                         <li>Civil Law</li>
//                         <li>Criminal Law</li>
//                         <li>Family Law</li>
...
//                 <p>&copy; {new Date().getFullYear()} | <a href="https://www.facebook.com/adv.prince.islam/" target="_blank" className="font-bold">Shamiul Islam & Associates</a>. All rights reserved. | Developed by <a href="https://www.facebook.com/techxbureau" target="_blank" className="font-bold">Tech<span className="text-orange-500">X</span>bureau</a></p>
//             </div>
//         </footer>
//     )
// }
